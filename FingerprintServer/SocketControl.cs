...
namespace FingerprintNetSample
{
            ...
            while(true)
            {
                ...
                try
                {
                    if (Listener.Pending())
                    {
                        ...
                        fingerPrint.LoadImageFromFile(SaveFilePath, 500);
                        imageSended = true;
                    }
                }
                catch (Exception ex)
    ...
    public class AsynchronousSocketListener
    {
        ...
        private static void ReadCallback(IAsyncResult ar)
        {
            ...
            if (bytesRead > 0)
            {
                ...
                if (content.IndexOf("<EOF>") > -1)
                {
                    ...
                    Send(handler, user.getUserDataByClientRequest(content));
                }
                else
                {
        ...
        private static int SendVariableData(Socket s, byte[] data)
        {
            int total = 0;
